...
# avatar = data[:pull_request][:user][:avatar]
# assignee = data[:pull_request][:assignee]

changes = data[:pull_request][:additions].to_i + data[:pull_request][:deletions].to_i
# "#{changes} changes in #{data[:pull_request][:commits]} commit(s)"
...
TerminalNotifier.notify data[:pull_request][:title],
  ...
  # appIcon: '/Users/jeff/.dotfiles/webhooks/GitHub.icns'
